 ...
 */
package com.clarks.core.constants;

/**
 * Global class for all ClarksCore constants. You can add global constants for your extension into this class.
 */
public final class ClarksCoreConstants extends GeneratedClarksCoreConstants
{
	public static final String EXTENSIONNAME = "clarkscore";


	private ClarksCoreConstants()
	{
		//empty
	}
