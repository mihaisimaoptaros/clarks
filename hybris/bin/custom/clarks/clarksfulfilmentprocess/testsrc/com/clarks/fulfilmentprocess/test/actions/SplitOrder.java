 ...
 */
package com.clarks.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ClarksFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ClarksFulfilmentProcessConstants.PARENT_PROCESS);
