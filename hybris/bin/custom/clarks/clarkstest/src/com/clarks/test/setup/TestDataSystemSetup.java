...
import com.clarks.test.constants.ClarksTestConstants;
import com.clarks.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ClarksTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/clarkstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/clarkstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/clarkstest/import/cstickets.impex");
			...
			importImpexFile(context, "/clarkstest/import/csquotes.impex");
		}
	}
}
