 ...
 */
package com.clarks.cockpits.setup;
...
import com.clarks.cockpits.constants.ClarksCockpitsConstants;
 ...
 */
@SystemSetup(extension = ClarksCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ClarksCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ClarksCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ClarksCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/clarkscockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
